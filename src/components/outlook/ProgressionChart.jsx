...
// `topN` teams ranked by title-win probability.
export function ProgressionChart({ teams, probs, topN = 12 }) {
  const ranked = useMemo(
    () => teams.slice().sort((a, b) => probs[b.code].W - probs[a.code].W).slice(0, topN),
    [teams, probs, topN]
  );
